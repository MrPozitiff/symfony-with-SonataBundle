...
class Image
{
     ...
     * @var Product
     *
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\Product", mappedBy="mainImage", cascade={"persist"})
     */
    private $product;
    ...
    {
        return 'uploads/media/img/' . $this->getFilename();
    }
